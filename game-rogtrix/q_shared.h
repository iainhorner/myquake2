...
//g_maplist.c
#define MAX_MAP_NAME_LEN 25


// Nick - 07/09/2005 - Random map stuff - Musashi
//CW++
#define MAX_MAPS        1000
#define MAX_OLDMAPS	7               //TODO: add this to a Cvar
//CW--
// End Nick
...
#define PLAYER_MODEL "players/male/tris.md2"
...
#define DEBRIS_TWO "models/objects/debris2/tris.md2"
#define GIB_SOUND "misc/udeath.wav"
...
#define STAT_COUNTDOWN			18
#define	STAT_MAPLEFT			19
#define STAT_HOMINGCELLS		20
#define STAT_DEATHS_ICON		21 // Use the a_blaster icon!
#define STAT_DEATHS			22 // Nick 29/08/2005 - Count deaths!
...
//terminating strncpy - Nick - make it use Q_strncpy in q_shared.c
#define Q_strncpy(dst, src, len) \
do { \
        Q_strncpyz ((dst), (src), (len)); \
        (dst)[(len)] = 0; \
} while (0)
