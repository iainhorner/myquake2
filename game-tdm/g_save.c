...
//ZOID
	...
	team_a_model = gi.cvar("team_a_model", "male", CVAR_SERVERINFO);
	team_b_model = gi.cvar("team_b_model", "male", CVAR_SERVERINFO);
	team_a_skin = gi.cvar("team_a_skin", "ctf_r", CVAR_SERVERINFO);
	team_b_skin = gi.cvar("team_b_skin", "ctf_b", CVAR_SERVERINFO);
	team_a_name = gi.cvar("team_a_name", "BLUE", CVAR_SERVERINFO);
	team_b_name = gi.cvar("team_b_name", "RED", CVAR_SERVERINFO);
//ZOID
